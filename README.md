...
KWU: `--recompute-activations` is no longer a valid option to reduce confusion. Please set `--recompute-granularity` to a non-None value to enable selective activation/MLP recomputation.
